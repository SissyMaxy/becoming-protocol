-- Migration 026: Create get_reminder_stats RPC function
-- This function returns reminder statistics for a user
-- Uses reminder_responses table to track responded reminders
...
BEGIN
  SELECT json_build_object(
    ...
    'streak', 0  -- Calculated separately by get_reminder_streak
  ) INTO result
  FROM reminder_responses
  WHERE user_id = p_user_id;

  -- Return empty stats if no responses exist
...
-- Create get_reminder_streak function
