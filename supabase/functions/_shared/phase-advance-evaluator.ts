// Pure phase-advance evaluator (Deno mirror of src/lib/phase-advance/evaluator.ts).
// Keep the two files in sync. Pure TS, no Deno globals — the edge fn imports
// this; the unit tests import the src/lib copy. The migration's
