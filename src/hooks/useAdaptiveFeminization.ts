...
export function useAdaptiveFeminization(): UseAdaptiveFeminizationReturn {
  ...
  const vectorDisplayInfos: VectorDisplayInfo[] = ALL_VECTORS.map(vector => {
    ...
    const colors: Record<string, string> = {
      ...
      voice_training: '#B06B61',
      movement_posture: '#C4847A',
      skincare_beauty: '#D4A89C',
      hair_styling: '#96524A',
      fitness_body: '#7A3E38',
      wardrobe_building: '#5E2B27',
      public_presentation: '#3D2B2B',
      social_relationships: '#B06B61',
      professional_navigation: '#C4847A',
      family_dynamics: '#D4A89C',
      dating_intimacy: '#96524A',
      community_integration: '#7A3E38',
      identity_integration: '#5E2B27',
      emotional_processing: '#3D2B2B',
      self_perception: '#B06B61',
      memory_narrative: '#C4847A',
      future_visioning: '#D4A89C',
      authenticity_expression: '#96524A',
      hormone_therapy: '#7A3E38',
      laser_electrolysis: '#5E2B27',
      surgical_planning: '#3D2B2B',
      legal_documentation: '#B06B61',
      name_change: '#C4847A',
      wardrobe_purge: '#D4A89C',
      // Sissification - purple spectrum
      denial_training: '#c9557f',
      edge_conditioning: '#edaec5',
      arousal_feminization_link: '#d8b4fe',
      orgasm_transformation: '#b8467a',
      chastity_integration: '#c9557f',
      service_orientation: '#6d28d9',
      protocol_adherence: '#5b21b6',
      authority_response: '#c9557f',
      task_completion: '#edaec5',
      punishment_acceptance: '#d8b4fe',
      masculine_capability_atrophy: '#b8467a',
      guy_mode_discomfort: '#c9557f',
      deadname_disconnection: '#6d28d9',
      old_self_alienation: '#5b21b6',
      feminine_default_state: '#c9557f',
      automatic_responses: '#edaec5',
      speech_patterns: '#d8b4fe',
      consumption_preferences: '#b8467a',
      social_role_adoption: '#c9557f',
