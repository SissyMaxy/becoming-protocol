...
export const GINA_FEMINIZING_ACTIVITIES: WeekendActivity[] = [
  ...
  // Level 2 - "Taking care of each other"
  {
    ...
    yourRole: 'receptive',
    ginaFraming: "Can you paint my toes? I got this color and I want to see how it looks.",
  ...
  },
  {
    ...
    yourRole: 'receptive',
    ginaFraming: "I want to try shaving my legs. Can you help me? You're way more careful than I am.",
  ...
  },
  {
    ...
    yourRole: 'passive',
    ginaFraming: "Can you clean up my brows? You always notice when they're messy.",
