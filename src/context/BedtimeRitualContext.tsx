...
export function BedtimeRitualProvider({ children }: { children: ReactNode }) {
  ...
  // NOTE: the §2.4 TMR sleep-onset cue player was removed here on purpose —
  // audio delivery into the falling-asleep window is below-awareness delivery,
  // a held container-breaker. recon-sleep-cue-builder stays dormant server-side.
