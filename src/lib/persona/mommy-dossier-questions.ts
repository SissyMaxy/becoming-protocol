...
export const DOSSIER_QUESTIONS: DossierQuestion[] = [
  ...
  },
  {
    ...
    placeholder: "from: baby / sweet thing / sweet boy / pretty thing / good boy / Mama's pretty thing / precious / my needy little thing / darling",
    importance: 4,
    tone: 'soft',
    input: 'short',
  },
  {
    ...
    placeholder: "e.g. 'after first HRT dose' / 'right now, never again'",
    importance: 5,
    tone: 'direct',
    input: 'short',
  },
  ...
  },
  {
    ...
    placeholder: "e.g. 'I get warm in my chest', 'my stomach flutters', 'I get hard first then desperate'",
    importance: 4,
    tone: 'filthy',
    input: 'long',
  },
  ...
  },
  {
    ...
    category: 'history',
    prompt: "First time you remember feeling the pull toward her — toward softness, toward the girl in the mirror, sweet thing. Where you were, what triggered it, how old. The earlier the better.",
    placeholder: "Anchors the 'this pull was always in you' narrative",
    importance: 4,
    tone: 'soft',
    input: 'long',
  },
  ...
  },
  {
    ...
    category: 'preferences',
    prompt: "Is there a phrase that means STOP THE PROTOCOL, sweet thing? Or do you want Mama to never break frame regardless of what you say?",
