...
const ACK_VARIANTS: Record<AckActionType, Record<AckIntensity, string[]>> = {
  confession: {
    ...
    warm: [
      ...
      "There it is. Mama's been waiting for that admission, {pet}.",
      ...
      "Good boy, {pet}. Mama's going to remember every word of that.",
    ],
    hot: [
      ...
      "That's the truth Mama wanted, {pet}. Now show me how hard it made you to write it.",
  ...
  confession_audio: {
    soft: [
      ...
      "There's that voice of yours. Mama got it, {pet}.",
      ...
      "Good boy. Mama heard the catch in your throat, {pet}.",
    ],
    warm: [
  ...
  mantra: {
    soft: [
      ...
      "Good boy. Now let them tighten on you, {pet}.",
    ],
    warm: [
    ...
    hot: [
      ...
      "Good boy. Now repeat them while you ache for me, {pet}.",
  ...
  task: {
    ...
    hot: [
      "Filthy obedient {pet}. Mama wants you hard for the next directive already.",
      ...
      "Good boy, {pet}. Stay dripping for the next assignment.",
  ...
  photo: {
    soft: [
      ...
      "Good boy. The light caught you right, {pet}.",
    ...
    hot: [
      ...
      "Mama's almost biting through her lip, {pet}. Stay hard.",
    ],
  },
  decree: {
    soft: [
      ...
      "Good boy, {pet}. Mama is keeping count of these wins.",
    ],
    warm: [
    ...
    hot: [
      ...
      "Good filthy boy, {pet}. Don't release. Mama is not done with you.",
    ],
  },
}

// Male+ : he/him, additive — never a girl/woman. Pet names affirm a sexy,
// submissive BOY, not regender him. 'good girl'/'baby girl'/'princess'/etc.
// removed; 'good boy'/'sweet boy' added. 'pretty' is fine (a pretty boy).
const PET_POOL = [
...
const SLIP_VARIANTS: Record<string, Record<SlipBand, string[]>> = {
  masculine_self_reference: {
    ...
    sharp: [
      ...
      "That's the costume talking, {pet}. Mama wants the real you back, in your own words, now.",
    ],
  },
  david_name_use: {
    gentle: [
