...
const TEMPLATES: ScriptTemplate[] = [
  ...
  },
  {
    ...
    phase: 4,
    intensity: 4,
    template: `We're going to layer triggers tonight, {{name}}. Stack them. [pause] First: "good boy." [pause] Feel the warmth. The validation flooding through you. [pause] Now: "{{trigger}}." [pause] Feel that one too. Different sensation, same obedience. [breathe] Now both together. "Good boy — {{trigger}}." [pause] The combination hits harder than either one alone. They amplify each other. [pause] Day {{denial_day}}. Your brain is desperate for reward. These triggers ARE the reward now. My words are the only pleasure you get. [pause] And that's exactly how this works.`,
  ...
  // ─────────────────────────────────────────
  {
    ...
    phase: 1,
    intensity: 1,
    template: `You don't have to listen closely. [pause] Just let this play in the background. Let my voice become part of the room, like music. Like white noise. [breathe] But know that even at the edge of hearing, the words are landing. [pause] {{name}}. [pause] Obey. [pause] Surrender. [pause] Good boy. [breathe] Your subconscious doesn't need volume. It doesn't need attention. It just needs repetition. [pause] And every minute this plays, the words sink deeper. The associations strengthen. The conditioning continues. [pause] You don't have to do anything right now. Just exist in this space. Just be {{name}}. Just let the becoming happen.`,
    variables: ['name'],
    duration_estimate: 45,
    trigger_phrases: ['good boy', 'obey', 'surrender'],
  },
  {
    id: 'ambient-002',
    category: 'ambient',
