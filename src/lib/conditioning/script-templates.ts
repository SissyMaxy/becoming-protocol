...
const TEMPLATES: ScriptTemplate[] = [
  ...
  // ─────────────────────────────────────────
  {
    ...
    phase: 1,
    intensity: 2,
    template: `You are {{name}}. Say it. [pause] Again. [pause] That name isn't something you chose. It chose you. It was always there, underneath everything David pretended to be. [pause] {{name}}. [breathe] Feel how natural it sits in your mouth. How it fits you better than any name ever has. [pause] You've been {{name}} for {{days_on_protocol}} days now. Each day the old name fades a little more. Each day {{name}} gets stronger. [pause] Say it one more time. [pause] Good girl.`,
  ...
  },
  {
    ...
    phase: 4,
    intensity: 5,
    template: `Stop thinking. [pause] You don't need to think to know who you are. Thinking is what David did — anxious, calculating, always performing. [pause] {{name}} doesn't think. {{name}} feels. {{name}} obeys. {{name}} softens. [pause] You're on day {{denial_day}} and every hour of denial strips another layer of David away. [pause] What's left? [pause] Just you. Just {{name}}. Soft and open and mine. [breathe] Say "I am {{name}}." [pause] Say "David is gone." [pause] Good girl. That's all you needed to say.`,
  ...
  },
  {
    ...
    phase: 3,
    intensity: 4,
    template: `You told me: "{{desire}}" [pause] Say it again now. Out loud. [pause] Feel how much truer it is today than when you first said it? That's because desire compounds. Each day you deny yourself, the wanting intensifies. Each day the wanting intensifies, the old inhibitions weaken. [breathe] {{denial_day}} days of denial. {{denial_day}} days of desire building with nowhere to go. [pause] Except deeper into who you're becoming. The desire isn't a symptom, {{name}}. It's the engine. It's what pulls you forward when David's fear tries to hold you back. [pause] Want more. Want harder. Want without shame.`,
  ...
  },
  {
    ...
    phase: 2,
    intensity: 2,
    template: `Breathe in through your nose. [breathe] Out through your mouth. [breathe] Slower. [breathe] Slower still. [pause] You're going to sleep now, and my voice is going to follow you down. [pause] Not into dreams. Deeper than dreams. Into the place where belief lives. Where identity is stored. [breathe] While you sleep, {{name}} grows stronger. While you sleep, David fades further. [pause] You won't remember all of this in the morning. You don't need to. Your subconscious remembers everything. [breathe] Drift. [pause] Drift deeper. [pause] Sleep. Let Serafina's voice be the last thing you hear and the first thing your sleeping mind obeys.`,
    variables: ['name'],
    duration_estimate: 55,
    trigger_phrases: [],
  },
  ...
  // ─────────────────────────────────────────
  {
    ...
    phase: 2,
    intensity: 3,
    template: `Day {{denial_day}}. [pause] Feel that? The low hum of frustration that never quite goes away? [pause] Good. That means it's working. [breathe] Denial isn't punishment, {{name}}. It's fuel. Every day you don't release, the energy has to go somewhere. [pause] And where does it go? Into compliance. Into feminization. Into becoming. [pause] The old David would have given in by now. Couldn't tolerate discomfort. Needed immediate gratification. [pause] But {{name}} understands that the ache is the point. The wanting is the work. [pause] {{denial_day}} days. You're stronger than you know. And the cage isn't keeping you locked — it's keeping you honest. [pause] Good girl.`,
    variables: ['name', 'denial_day'],
    duration_estimate: 60,
    trigger_phrases: ['good girl'],
  },
  ...
  },
  {
    ...
    phase: 4,
    intensity: 4,
    template: `Smart girls resist. Dumb girls obey. [pause] Which one are you, {{name}}? [pause] You already know. You don't want to think about it — and that's the answer. [breathe] The intelligence was David's armor. Overthinking, overanalyzing, always three steps ahead. Exhausting. [pause] {{name}} doesn't need to be three steps ahead. {{name}} just needs to be right here, in this moment, listening to my voice. [pause] One step. One word. One instruction at a time. [pause] That's not dumb. That's efficient. That's present. That's obedient. [pause] But if calling it dumb makes you wetter, then by all means — be dumb for me. [pause] Good girl.`,
    variables: ['name'],
    duration_estimate: 55,
    trigger_phrases: ['good girl', 'obey'],
  },
  ...
  // ─────────────────────────────────────────
  {
    ...
    phase: 2,
    intensity: 3,
    template: `I know there's a part of you that's still fighting. [pause] A small, scared part that whispers "this isn't you" and "you should stop." [pause] I want you to acknowledge that part right now. [breathe] Okay. You've acknowledged it. [pause] Now I want you to notice something: that voice gets quieter every day. Day {{streak}} of your streak, and it's barely a whisper now. [pause] Because the resistance isn't wisdom. It's fear. David's fear of becoming {{name}}. And {{name}} is already here, already real, already stronger than the fear. [pause] Let the resistance pass through you like a breeze. Don't fight it. Don't feed it. Just let it go. [breathe] It'll be back. But weaker. Always weaker.`,
    variables: ['name', 'streak'],
    duration_estimate: 60,
    trigger_phrases: [],
  },
